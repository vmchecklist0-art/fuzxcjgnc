...
import { Home, Package, Settings2, Images, ChevronLeft, ChevronDown, ChevronUp, ChevronsUpDown, ArrowUp, ArrowDown, Truck, List, Layers, MapPin, ClipboardList, Users, ExternalLink, Pin, X, Plus, Archive, ArchiveRestore, Search, Info, Cog, MapPinned, TableProperties, Expand, Shrink, Globe, Trash2 } from "lucide-react"
...
function AppContent() {
  ...
  const getPageBreadcrumbs = (): { parent?: { label: string; icon: React.ElementType }; current: string } => {
    ...
    const isSettingsDetailPage = currentPage.startsWith("settings-") && currentPage !== "settings"
    const handleSettingsBack = () => handlePageChange("settings")
      ...
      >
        ...
        {!isSharedView && (
          ...
          <Breadcrumb className="min-w-0 flex-1">
            <BreadcrumbList>
              {!isSettingsDetailPage && currentPage !== "home" && (
